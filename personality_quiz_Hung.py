...
def main():
    ...
    It also allow the user to build their own fun quiz.
       Args:
        Personal (int): users will input their personal information or not.
        Users (int): To see what users can guess about their personality. 

       Returns:
        Option (int): user’s can create their own quiz or be satisfied with their own quiz.
        
       Side effects:
        Personality quiz (int): user’s result will be added and display a summary of the quiz.
    """
    myid=get_user_info()
